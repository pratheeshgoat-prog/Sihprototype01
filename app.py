...
# ============================================================
# HYDROSAFE — DEMO LOGIN / ROLE-BASED ACCESS
# ============================================================
...
DEMO_USERS = {
    "admin": {"password": "hydrosafe", "role": "Administrator"},
    "officer": {"password": "hydrosafe", "role": "Disaster Management Officer"},
    "responder": {"password": "hydrosafe", "role": "Emergency Responder"},
    "viewer": {"password": "hydrosafe", "role": "Viewer"},
}
...
if not st.session_state.authenticated:
    st.markdown(
        ...
        <div class="hs-login">
            <div class="hs-title">🌊 HYDROSAFE</div>
            <div class="hs-subtitle">
                AI-Powered Dam-Break Flood Decision Support
            </div>
        </div>
        """,
    ...
    st.info(
        "SIH demo accounts: admin, officer, responder, viewer. "
        "Password for all demo accounts: hydrosafe"
    )
    st.caption(
        "Prototype authentication only. Production deployment should use "
        "secure password hashing, HTTPS, RBAC and an identity provider."
    )
    st.stop()
...
with st.sidebar:
    st.success(
        f"Signed in: **{st.session_state.username}**\n\n"
